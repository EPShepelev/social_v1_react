...
<Formik
     ...
     >
      ...
      isSubmitting }) => (
        ...
        <Field name={"aboutMe"} placeholder="About" value={values.aboutMe || ""} onChange={handleChange} onBlur={handleBlur} className={style.inputField} />
        {errors.aboutMe && touched.aboutMe && errors.aboutMe}
        <Field name={"github"} placeholder="github link" value={values.github || ""} onChange={handleChange} onBlur={handleBlur} className={style.inputField} />
